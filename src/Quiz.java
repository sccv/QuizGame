...
public class Quiz implements ActionListener{
    ...
    String[][] options = {
            {"Sun Microsystems", "Starbucks", "Microsoft", "McDonald"},
            {"1989", "1996", "1972", "1985"},
            {"Apple", "Latte", "Oak", "Koffing"},
            {"Steve Jobs", "Bill Gates", "James Gosling", "Marry Jane"}
    };
    ...
    Timer timeLeft = new Timer(1000, new ActionListener() {
        @Override
    ...
    public Quiz() {
        ...
        time_label.setBounds(330, 542, 200, 30);
        time_label.setBackground(new Color(50, 50, 50));
        time_label.setForeground(new Color(255, 0, 0));
        time_label.setFont(new Font("MV Boli", Font.PLAIN, 30));
